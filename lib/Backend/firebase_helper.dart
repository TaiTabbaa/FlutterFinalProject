...
// import 'package:bm_social_qatar/backend/stordata.dart';
...
// final StoreData stordata = Get.put(StoreData());
// var logger = Logger();
...
// String storysListcollectionname = 'Storys';
// ////////////////////////////////////////////////////////////////////////////////////////
// registrationProcess({
//   String fname,
//   String mName,
...
//         .collection(storysListcollectionname)
//         .orderBy('createdDate')
//         .snapshots();
...
//     {String content, File img, String userId, String username}) async {
//   try {
//     FieldValue timestamp = FieldValue.serverTimestamp();

//     DocumentReference documentReference =
//         await firestore.collection(storysListcollectionname).add({
//       'content': content,
//       'image': img,
//       'userId': userId,
//       'username': username,
...
//       insertimgyourstory(documentReference.id, img);
//       return documentReference.id;
//     } else {
//       throw Exception('story has not been uploaded');
//     }
//   } on Exception catch (e) {
//     CustomDialougs.utils
//         .showDialoug(messageKey: e.toString(), titleKey: 'alert');
...
// Future<String> insertimgyourstory(String docid, File image) async {
//   try {
//     DateTime dateTime = DateTime.now();

//     StorageTaskSnapshot snapshot = await firebaseStorage
//         .ref()
//         .child('storyimages/$docid/$dateTime.png')
//         .putFile(image)
//         .onComplete;
