              ...
              onTap: () {
                if (namecontroller.text == '') {
                  ...
                  CoolAlert.show(
                    context: context,
                    type: CoolAlertType.error,
                    text: 'Please Enter Your University Number',
                  );
                  ...
                  CoolAlert.show(
                    context: context,
                    type: CoolAlertType.error,
                    text: 'Please Enter Your University Level',
                  );
                } else if (hourpricecontroller.text == '') {
                  CoolAlert.show(
                    context: context,
                    type: CoolAlertType.error,
                    text: 'Please Enter Your Hour Price',
                  );
                } else if (hourNumcontroller.text == '') {
                  CoolAlert.show(
                    context: context,
                    type: CoolAlertType.error,
                    text: 'Please Enter Your Hour Number',
                  );
                  ...
                  registerForMenha(
                      ...
                      .then((value) => {Get.to(() => SuccessfullScr())});
                }
              },
              child: Container(
                width: 161.w,
